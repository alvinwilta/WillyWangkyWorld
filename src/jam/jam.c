...
// Deskripsi : Membuat ADT jam.c dari jam.h
/* ***************************************************************** */
/* DEFINISI PRIMITIF                                                 */
/* ***************************************************************** */
...
JAM DetikToJAM (long N)
{
    JAM J;
    Hour(J) = (N % 86400) / 3600;
    Minute(J) = (N % 86400) % 3600 / 60;
    Second(J) = (N % 86400) % 3600 % 60;
    return J;
}
...
{
    Second(J) += 1;
    return (DetikToJAM (JAMToDetik(J)));
}
...
long Durasi (JAM JAw, JAM JAkh)
{
    ...
    else{return(JAMToDetik(JAw)-JAMToDetik(JAw));}
}
